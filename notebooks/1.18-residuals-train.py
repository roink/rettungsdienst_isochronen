...
plt.ylim(-15, 15)
plt.tight_layout()
plot_output_path = "../reports/figures/1.18-Residuen-Vorhersage.png"
...
plt.ylim(-15,15)
plt.tight_layout()
plt.savefig("../reports/figures/1.18-Residuen-Boxplot.png", dpi=300)
plt.show()
...
plt.ylim(0, 30000)
plt.tight_layout()
plot_output_path = "../reports/figures/1.18-Residuen-Verteilung.png"
plt.savefig(plot_output_path, dpi=300)
plt.show()
...
fig.tight_layout()
fig.savefig("../reports/figures/1.18-Residuen-QQ.png", dpi=300)
plt.show()
