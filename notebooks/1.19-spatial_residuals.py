...
def plot_bin_residuals(gdf, val_col, title, outpath, cmap='RdBu'):
    ...
    ax.set_axis_off()
    ax.set_title("Räumliche Verteilung der Residuen", fontsize=16, pad=12)
...
plot_bin_residuals(
    bins_res_gdf,
    'mean_residual',
    "Durchschnittliches Residuum [min]",
    "../reports/figures/1.19-Binned_Average_Residuals_Filtered.jpg"
)
