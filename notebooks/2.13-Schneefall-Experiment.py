...
# ----------------------------------------------------------------------------------------
temp_min, temp_max = train_data["hourly_snowfall"].min(), train_data["hourly_snowfall"].max()
...
plt.xlabel(r'Schneefall $\left[\mathrm{L}\,\mathrm{m}^{-2}\,\mathrm{h}^{-1} ~\text{äquivalent}\right]$', 
            labelpad=8)
plt.ylabel("Δ Hilfsfrist [min]")
plt.title("Effekt von Schneefall auf die Hilfsfrist")
plt.tight_layout()
plot_output_path = "../reports/figures/2.13-Schneefall-Hilfsfrist.png"
