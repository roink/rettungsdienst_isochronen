...
# Check if 'ZIELORT_ADRESSE' is categorical and count unique values
unique_values = data['ZIELORT_ADRESSE'].nunique()
value_counts = data['ZIELORT_ADRESSE'].value_counts()

print(f"'Bezeichnung ZIELORT_ADRESSE' has {unique_values} unique values.")
print("\nValue Counts:")
print(value_counts)
