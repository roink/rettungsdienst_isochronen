...
# ----------------------------------------------------------------------------------------
temp_min, temp_max = train_data["temperature_celsius"].min(), train_data["temperature_celsius"].max()
temperatures = np.linspace(temp_min, temp_max, 100)
...
for temp in temperatures:
    run_experiment({"temperature_celsius": temp}, f"temperature_celsius_{temp:.2f}")
...
plt.plot(temperatures, stats_df["mean_diff"], label="Differenz [min]", color="blue")
...
plt.title("Einfluss der Temperatur auf die Hilfsfrist")
plt.tight_layout()
plot_output_path = "../reports/figures/2.10-Temperatur-Hilfsfrist.png"
