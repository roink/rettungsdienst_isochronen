...
Single-script preprocessing pipeline that:
  1. Loads raw Einsatzdaten (2018‑22 and 2023), combines them.
...
# Input raw data
EINSATZ_2023_FILE       = RAW_DIR / "2024-10-01 einsatzdaten23_modified_export.CSV"
EINSATZ_2018_22_FILE    = RAW_DIR / "2024-11-28 einsatzdaten18-22_modified_export.CSV"
...
# Outputs
COMBINED_EINSATZ_PARQUET       = INTERIM_DIR / "combined_einsatz_data.parquet"
COMBINED_EINSATZ_ORS_PARQUET   = INTERIM_DIR / "combined_einsatz_ORS.parquet"   
COMBINED_EINSATZ_WEATHER_PARQUET = INTERIM_DIR / "combined_einsatz_weather.parquet"
COMBINED_EINSATZ_WEATHER_DATES_PARQUET = INTERIM_DIR / "combined_einsatz_weather_dates.parquet"
FEIERTAGE_FERIEN_PARQUET       = INTERIM_DIR / "Feiertage-Ferien.parquet"
ALL_DATA_PARQUET               = INTERIM_DIR / "all-data.parquet"
FINAL_DATA_PARQUET             = INTERIM_DIR / "selected-data.parquet"
